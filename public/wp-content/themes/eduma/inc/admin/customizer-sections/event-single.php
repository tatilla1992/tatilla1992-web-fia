...
thim_customizer()->add_field(
	array(
		...
		'tooltip'  => esc_html__( 'Allows you to choose a layout to display for all event single pages.', 'eduma' ),
...
thim_customizer()->add_field(
	array(
		'id'       => 'thim_event_single_hide_title',
		'type'     => 'switch',
...
thim_customizer()->add_field(
	array(
		'type'     => 'text',
		'id'       => 'thim_event_single_sub_title',
...
thim_customizer()->add_field(
	array(
		'type'      => 'image',
		'id'        => 'thim_event_single_top_image',
...
thim_customizer()->add_field(
	array(
		'id'          => 'thim_event_single_title_color',
		'type'        => 'color',
...
thim_customizer()->add_field(
	array(
		'id'          => 'thim_event_single_sub_title_color',
		'type'        => 'color',
