		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li id="members-order-select" class="last filter">
					<label for="members-order-by"><?php _e( 'Order By', 'eduma' ); ?></label>
					<select id="members-order-by">
						<option value="active"><?php _e( 'Last Active', 'eduma' ); ?></option>
						<option value="newest"><?php _e( 'Newest Registered', 'eduma' ); ?></option>

						<?php if ( bp_is_active( 'xprofile' ) ) : ?>
							<option value="alphabetical"><?php _e( 'Alphabetical', 'eduma' ); ?></option>
						<?php endif; ?>
