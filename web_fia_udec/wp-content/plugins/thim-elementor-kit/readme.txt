...
~ Added: Options slider on Mobile for widget List Post, List Course, List Product with layout default
...
= 1.2.3 (2024-08-10) =
~ Fixed: translate wpml.
~ Tweak: style single course item.
...
= 1.2.0 (2024-07-08) =
~ Added: option effect mobile.
~ Added: filter to import demo.
~ Fixed: stop video when close popup.
~ Tweak: nav menu.

= 1.1.9.1 (2024-05-10) =
~ Fixed: default draw icon svg.
~ Fixed: security.
