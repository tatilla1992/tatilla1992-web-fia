...
thim_customizer()->add_field(
	array(
		'id'       => 'thim_testimonials_cate_hide_breadcrumbs',
		'type'     => 'switch',
...
thim_customizer()->add_field(
	array(
		'id'       => 'thim_testimonials_cate_hide_title',
		'type'     => 'switch',
...
thim_customizer()->add_field(
	array(
		'type'      => 'image',
		'id'        => 'thim_testimonials_cate_top_image',
...
thim_customizer()->add_field(
	array(
		'id'          => 'thim_testimonials_cate_bg_color',
		'type'        => 'color',
...
thim_customizer()->add_field(
	array(
		'id'          => 'thim_testimonials_cate_title_color',
		'type'        => 'color',
...
thim_customizer()->add_field(
	array(
		'id'          => 'thim_testimonials_cate_sub_title_color',
		'type'        => 'color',
