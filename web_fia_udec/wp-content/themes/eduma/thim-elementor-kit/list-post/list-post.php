...
class Thim_Ekit_Widget_List_Post extends Widget_Base {
	...
	public function get_icon() {
		return 'eduma-eicon thim-widget-icon thim-widget-icon-list-post';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options'   => [
					...
					'feature-post' => esc_html__( 'Style 05 -Feature Post', 'eduma' ),
				],
				'condition' => [
					'layout' => [ 'base' ]
				]
		...
		$this->add_control(
			'show_read_time',
			[
				'label'     => esc_html__( 'Show Read Time', 'eduma' ),
				'default'   => false,
				'type'      => Controls_Manager::SWITCHER,
				'condition' => [
					'style' => [ 'feature-post' ]
	...
	protected function register_controls_style_content() {
		...
		$this->add_control(
			'feature_post_absolute',
			array(
				'label'     => esc_html__( 'Absolute', 'eduma' ),
				'type'      => Controls_Manager::SWITCHER,
		...
		$this->add_group_control(
			Group_Control_Typography::get_type(),
			array(
				'name'     => 'content_title_feature_typography',
				'label'    => esc_html__( 'Typography Feature', 'eduma' ),
				'selector' => '{{WRAPPER}}.thim-widget-list-post .sc-list-post .item-post:first-child .title a',
				'condition' => array(
					'style' => 'feature-post',
				),
			)
